...
boost=my_canvas.create_text(210,15,text="BOOOOST",fill="black")
stop=my_canvas.create_text(40,15,text="BARRİER",fill="black")
invisible=my_canvas.create_text(420,15,text="İNVİSİBLE BALL",fill="black")
...
while True:
    ...
    if sayac ==2 or sayac==13:
        ...
        my_canvas.itemconfig(stop,fill="blue")
    ...
    if sayac==4 and xspeed>=0  or sayac==15 and xspeed>=0:
        ...
        my_canvas.itemconfig(boost,fill="blue")
    ...
    #TOPU GÖRÜNMEZ YAP, GOLE VE RAKETTEN SEKMESİNE GÖRE YENİDEN AYARLANACAK
